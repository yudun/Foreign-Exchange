...
public class ConfigDataSingleton {
    ...
    // If we read from Cassandra, here is the config for our database
    public String CONTACT_POINT = "127.0.0.1";

    public String KEYSPACE = "financialdata";

    public String TRAINING_DATA_TABLENAME = "trainingdata";

    public String TEST_DATA_TABLENAME = "testdata";

    public String PERFORMANCE_METRICS_TABLENAME = "performanceMetrics";
    ...
    public double  PURITY_THREHOLD = 1;
    ...
    public String LABEL = "EURUSD-2015-01.csv";

    // define the location of our original data
    public String INPUT_DATA_DIR = "../../lab1/alignedData";

    // define the path of the training set
    public String TRAINING_DATA_LOCATION = "../../lab2/trainingSet";

    // define the path of the test set
    public String TEST_DATA_LOCATION = "../../lab2/testSet";

    // define the dir path where we will save our trees to
    public String SERILIZED_DIR_LOCATION = "../../lab3/forestFiles/";

    // define the prefix of name of our tree files
    public String SERILIZED_FILE_NAME_PREFIX = "tree";
    ...
    public final int TREENUM = 100;

    // The ration of training subSet
    public final double TRAINING_SUBSET_RATIO = 2.0/3;

    // The dimension of our subspace
    public int SUBSPACE_DIMENSION;



    // Map Reduce Config
    public String mapreduceOutputFile = "output";


    // Spark Config
    // The master URL to connect to
    public String masterURL = "localhost";

    //name for this Spark application
    public String appName = "SparkRandomForest";
