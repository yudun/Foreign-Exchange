...
public class ConfigDataSingleton {
    ...
    public static String CONTACT_POINT = "127.0.0.1";

    public static String KEYSPACE = "financialdata";

    public static String TRAINING_DATA_TABLENAME = "trainingdata";

    public static String TEST_DATA_TABLENAME = "testdata";

    public static String PERFORMANCE_METRICS_TABLENAME = "performanceMetrics";
    ...
    // Map Reduce Config
    public static String mapreduceOutputFile = "output";
